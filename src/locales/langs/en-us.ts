const local: App.I18n.Schema = {
  ...
  route: {
    ...
    document_naive: 'NaiveUI',
    document_antd: 'AntDesign',
    'document_element-plus': 'ElementPlus',
    document_alova: 'Alova'
  },
  page: {
    login: {
      common: {
        loginOrRegister: 'Login / Register',
        userNamePlaceholder: 'Please enter email',
    ...
    home: {
      branchDesc: 'Exam Admin Panel Home',
      ...
      projectNews: {
        title: 'Project News',
        moreNews: 'More News',
        desc1: 'Exam admin panel is online!',
        desc2: 'Question bank module is complete.',
        desc3: 'Exam configuration module is online!',
        desc4: 'RBAC module is complete.',
        desc5: 'Score statistics module is online!'
      },
